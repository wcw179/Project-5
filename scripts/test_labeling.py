"""
Script to test different triple-barrier labeling configurations without running the full pipeline.
"""
import sys
...
TEST_CONFIGS = [
    {"rr_multiples": [3.0, 8.0, 10.0, 15.0, 20.0], "atr_mult_base": 0.8},
    {"rr_multiples": [3.0, 5.0, 8.0, 10.0, 12.0], "atr_mult_base": 1.0},
